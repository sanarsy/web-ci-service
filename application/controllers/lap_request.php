...
class Lap_request extends CI_Controller {
...
function __construct(){
 ...
 function request_lap()
 {

 	    $data['header'] = "header/header";
        $data['navbar'] = "navbar/navbar";
        $data['sidebar'] = "sidebar/sidebar";
        $data['body'] = "body/lap_request";
		...
		$sql = "SELECT A.status, A.progress, A.tanggal,  A.tanggal_proses, A.tanggal_solved, 
				F.nama AS nama_teknisi, D.nama, A.category, A.id_service, A.tanggal, A.problem_detail
                FROM service A 
                LEFT JOIN karyawan D ON D.nik = A.reported 
    ...
    //    $data['dd_teknisi'] = $this->model_app->dropdown_teknisi($id_kategori);
        ...
        //TRACKING service
     //   $data_trackingservice = $this->model_app->data_trackingservice();
 ...
 function pilih_teknisi($id)
 {
        ...
        $sql = "SELECT A.status, D.nama, A.category, A.id_service, A.tanggal, A.problem_detail, A.skomputer, A.sparepart,
                FROM service A 
                LEFT JOIN karyawan D ON D.nik = A.reported 
 ...
 function view_progress_teknisi($id)
 {
        ...
        $sql = "SELECT A.status, A.progress, A.tanggal,  A.tanggal_proses, A.tanggal_solved, A.problem_detail, A.skomputer, A.sparepart,
				F.nama AS nama_teknisi, D.nama, A.category, A.id_service, A.tanggal
                FROM service A 
                LEFT JOIN karyawan D ON D.nik = A.reported 
                LEFT JOIN teknisi E ON E.id_teknisi = A.id_teknisi
                LEFT JOIN karyawan F ON F.nik = E.nik 
